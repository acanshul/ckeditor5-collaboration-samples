...
<head>
    <meta charset="utf-8">
    <title>CKEditor 5 – comments integration example</title>
...
<nav class="navbar navbar-expand-lg navbar-light bg-light mb-3">
    <a class="navbar-brand" href="/">
        ...
        <span class="align-middle ml-1">CKEditor 5 comments integration example</span>
    </a>
...
<footer class="bg-light">
    <div class="container text-center text-muted mt-5 pt-4 pb-4" style="font-size: .75em">
        <div class="col">
            <p class="mb-2">CKEditor 5 – The text editor for the Internet – <a href="https://ckeditor.com/ckeditor-5"
                                                                               target="_blank"
                                                                               rel="noopener noreferrer">https://ckeditor.com/ckeditor-5</a>
            </p>
            <p class="mb-0">Copyright © <?php echo date("Y") ?>, <a href="https://cksource.com/" target="_blank"
