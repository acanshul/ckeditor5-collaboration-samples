...
abstract class Controller
{
    ...
    /**
     * A shorthand method to access current Response object.
     *
     * @return Response
     */
    ...
    /**
     * Helper method that renders the template with given name and writes
     * the rendered content to response.
     *
