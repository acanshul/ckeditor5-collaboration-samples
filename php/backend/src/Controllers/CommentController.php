...
class CommentController extends Controller
{
    ...
    /**
     * Action that removes comment from the database.
     *
     * @param ServerRequestInterface $req
    ...
    /**
     * Action that updates comment in the database.
     *
     * @param ServerRequestInterface $req
     * @param ResponseInterface $res
     * @param array $args
    ...
    public function update(ServerRequestInterface $req, ResponseInterface $res, array $args): ResponseInterface
    {
        ...
        if ($comment['user_id'] != $this->getUserRepository()->getCurrentUserId()) {
            return $this->error('Could not update comment - comment can be deleted only by its author');
        }
    ...
    /**
     * Acton that returns all the comment in the thread with given comment thread id.
     *
    ...
    /**
     * Helper method that returns a comment with given id from the database.
     *
